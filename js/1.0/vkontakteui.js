...
(function () {
    try {
        VK._ui.require(['http://vk.com/js/common.js', 'http://vk.com/js/lib/ui_controls.js', 'http://vk.com/js/al/datepicker.js'], 'script');
        VK._ui.require(['http://vk.com/css/rustyle.css', 'http://vk.com/css/al/datepicker.css', 'http://vk.com/css/al/common.css', 'http://vk.com/css/ui_controls.css'], 'link');
    } finally {
 ...
 */
        ...
        /*
 * Пример использования: VK.date('datepicker', 200);
 *
 * Name: уникальный идентификатор
 * Width: ширина
 * Time: изначальное значения (unix)
 * Options: объект с опциями
 */
        VK.date = function (name, width, time, options) {
            ...
            if (!options) options = {};
            options.width = width;
            VK._ui.date[name] = new Datepicker(name, options);
        };
    };
})();